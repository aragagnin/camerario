var DiffCamEngine = (function() {
	...
	function init(options) {
		...
		captureWidth = options.captureWidth || 4096;
		captureHeight = options.captureHeight || 2160;
	...
	function stop() {
		...
		//motionContext.clearRect(0, 0, diffWidth, diffHeight);
	        isReadyToDiff = false;
	        //see https://stackoverflow.com/questions/61842322/web-camera-light-stays-on-after-stream-is-stopped
